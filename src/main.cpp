...
uint256 hashGenesisBlock("0x9ae714700f147effa2e67805e940f25325f2e58ef4048b2ea08b133ac16b1dd5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FootballCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FootballCoin Signed Message:\n";
...
{
    // FootballCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FootballCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FootballCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9ae714700f147effa2e67805e940f25325f2e58ef4048b2ea08b133ac16b1dd5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1400916494;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084542263;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FootballCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FootballCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running FootballCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FootballCoinMiner terminated\n");
        throw;
    }
}
